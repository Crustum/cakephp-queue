 ...
 * Job Pending Event
 *
 * Fired before a job is added to the queue so listeners can persist job metadata
 * before a worker can pick the job up (avoids race with fast jobs).
 */
class JobPendingEvent extends Event
{
    ...
    {
        parent::__construct('Crustum/Queue.Job.pending', null, [
